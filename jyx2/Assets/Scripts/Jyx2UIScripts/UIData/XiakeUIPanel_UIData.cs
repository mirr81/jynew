...
public partial class XiakeUIPanel
{
	...
	private List<Text> SkillList_Text;
	...
	public void InitTrans()
	{
		...
		SkillList_Text = new List<Text>();
		for (int i=1; i<=GameConst.MAX_SKILL_COUNT; i++)
			SkillList_Text.Add(transform.Find(string.Format("MainContent/SkillPanel/SkillText{0}", i)).GetComponent<Text>());
