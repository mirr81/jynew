...
public class UIHelper
{
    ...
    static string GetNeedItem(LItemConfig item)
    {
        ...
        {
            sb.Append($"재료:  {LuaToCsBridge.ItemTable[item.GenerateItemNeedCost].Name}\n");
        }
    ...
    public static string GetItemDesText(LItemConfig item)
    {
        ...
        {
            strBuilder.Append($"\n\n");
            strBuilder.Append("<size=28><color=#FFDB00>사용 인물</color></size>\n");
        ...
        if (!string.IsNullOrEmpty(effect))
        {
            ...
            //---------------------------------------------------------------------------
            strBuilder.Append("<size=28><color=#FFDB00>효과</color></size>\n".GetContent(nameof(UIHelper)));
            //---------------------------------------------------------------------------
            //---------------------------------------------------------------------------
        ...
        {
            strBuilder.Append($"\n\n");
            strBuilder.Append("<size=28><color=#FFDB00>요구사항</color></size>\n");
        ...
        {
            strBuilder.Append($"\n\n");
            strBuilder.Append("<size=28><color=#FFDB00>획득</color></size>\n");
        ...
        {
            strBuilder.Append($"\n\n");
            strBuilder.Append("<size=28><color=#FFDB00>필요물품</color></size>\n");
