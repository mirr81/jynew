...
public class GameConst
{
    ...
    //对话框最大可以显示字符
    public const int MAX_CHAT_CHART_NUM = 224;
    ...
    public static Dictionary<string, PropertyItem> ProItemDic = new Dictionary<string, PropertyItem>()
    {
        ...
        //---------------------------------------------------------------------------
        ["0"] = new PropertyItem(0, "MpType", "내력성질".GetContent(nameof(GameConst)), (int)Jyx2_MpType.Yang, (int)Jyx2_MpType.Yin),
        ["1"] = new PropertyItem(1, "MaxMp", "내력".GetContent(nameof(GameConst)), 40, 30),//创角用到 特殊
        ["2"] = new PropertyItem(2, "Attack", "공격".GetContent(nameof(GameConst)), 30, 20),//创角用到 特殊
        ["3"] = new PropertyItem(3, "Qinggong", "경공".GetContent(nameof(GameConst)), 30, 20),
        ["4"] = new PropertyItem(4, "Defence", "방어".GetContent(nameof(GameConst)), 30, 20),
        ["5"] = new PropertyItem(5, "MaxHp", "생명".GetContent(nameof(GameConst)), 50, 30),//创角用到 特殊
        ["6"] = new PropertyItem(6, "Heal", "의료".GetContent(nameof(GameConst)), 30, 20),
        ["7"] = new PropertyItem(7, "UsePoison", "중독".GetContent(nameof(GameConst)), 30, 20),
        ["8"] = new PropertyItem(8, "DePoison", "해독".GetContent(nameof(GameConst)), 30, 20),
        ["9"] = new PropertyItem(9, "Quanzhang", "권장".GetContent(nameof(GameConst)), 30, 20),
        ["10"] = new PropertyItem(10, "Yujian", "검술".GetContent(nameof(GameConst)), 30, 20),
        ["11"] = new PropertyItem(11, "Shuadao", "도술".GetContent(nameof(GameConst)), 30, 20),
        ["12"] = new PropertyItem(12, "Anqi", "암기".GetContent(nameof(GameConst)), 30, 20),
        //-------以上自动生成
        
        ["13"] = new PropertyItem(13, "Hp", "생명".GetContent(nameof(GameConst)), 30, 20),
        ["14"] = new PropertyItem(14, "Tili", "체력".GetContent(nameof(GameConst)), 30, 20),
        ["15"] = new PropertyItem(15, "Mp", "내력".GetContent(nameof(GameConst)), 40, 30),
        ["16"] = new PropertyItem(16, "MaxHp", "최대생명".GetContent(nameof(GameConst)), 50, 30),
        ["17"] = new PropertyItem(17, "MaxMp", "최대내력".GetContent(nameof(GameConst)), 40, 30),
        ["18"] = new PropertyItem(18, "Attack", "공격력".GetContent(nameof(GameConst)), 30, 20),
        ["19"] = new PropertyItem(19, "AntiPoison", "독저항".GetContent(nameof(GameConst)), 30, 20),
        ["20"] = new PropertyItem(20, "Qimen", "특수".GetContent(nameof(GameConst)), 30, 20),
        ["21"] = new PropertyItem(21, "Wuxuechangshi", "무학".GetContent(nameof(GameConst)), 30, 20),
        ["22"] = new PropertyItem(22, "Pinde", "도덕".GetContent(nameof(GameConst)), 30, 20),
        ["23"] = new PropertyItem(23, "AttackPoison", "독공".GetContent(nameof(GameConst)), 30, 20),
        ["24"] = new PropertyItem(24, "Zuoyouhubo", "좌우호박".GetContent(nameof(GameConst)), 30, 20),
        ["25"] = new PropertyItem(25, "IQ", "자질".GetContent(nameof(GameConst)), 100, 30),
        ["26"] = new PropertyItem(26, "Poison", "중독".GetContent(nameof(GameConst)), 30, 20),
        //["27"] = new PropertyItem(27, "HpInc", "생명성장".GetContent(nameof(GameConst)), 7, 3),
        //---------------------------------------------------------------------------
        //---------------------------------------------------------------------------
