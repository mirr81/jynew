...
namespace Jyx2
{
    ...
    public class BattleFieldModel
    {
        ...
        /// <summary>
        /// 获取一方武学常识总和    일방 무학 상식의 총계를 얻다
        ///
        /// 계산 방법 참조：https://tiexuedanxin.net/thread-365140-1-1.html
        ///
        /// 计算我方所有人武学常识之和×2。  모든 무술 지식의 합계*2를 계산합니다.
        ///（武学常识<80 不算，生命<0  不算，已死亡的人不算）   (무학상식<80은 제외, 생명<0은 제외, 사망한 사람은 제외)
        /// </summary>
