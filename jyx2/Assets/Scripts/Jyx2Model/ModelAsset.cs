...
namespace Jyx2
{
    ...
    public class ModelAsset : ScriptableObject
    {
        ...
        [BoxGroup("Data")] [Header("剑")] [SerializeReference]
        public SwordPart m_SwordWeapon;

        [BoxGroup("Data")] [Header("刀")] [SerializeReference]
        public KnifePart m_KnifeWeapon;

        [BoxGroup("Data")] [Header("长柄")] [SerializeReference]
        public SpearPart m_SpearWeapon;

        [BoxGroup("Data")] [Header("其他类型")] [SerializeReference]
        public List<WeaponPart> m_OtherWeapons;

        [EnumToggleButtons] [ShowInInspector] [LabelText("무기 유형 미리 보기")]
        ...
        public enum WeaponPartType
        {
            ...
            [LabelText("검")] Sword = 1,
            [LabelText("도")] Knife = 2,
            [LabelText("장병")] Spear = 3,
            [LabelText("기타")] Other = 4,
        }

#if UNITY_EDITOR
        [ButtonGroup("작업")]
        [Button("전체 미리보기", ButtonSizes.Large, ButtonStyle.CompactBox)]
        ...
        [ButtonGroup("작업")]
        [Button("미리보기 장면에서 무기 오프셋 데이터 가져오기", ButtonSizes.Large, ButtonStyle.CompactBox)]
    ...
    public class WeaponPart
    {
        ...
        [InlineEditor(InlineEditorModes.LargePreview, Expanded = true)] [InlineButton("LoadDefaultView", "기본 모델")]
