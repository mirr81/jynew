...
namespace Jyx2
{
    ...
    public class SkillCastHelper
    {
        ...
        public async UniTask Play()
        {
            ...
            {
                GameUtil.CallWithDelay(display.particleDelay, DisplayCastEft, Source);  // 특수효과 delay
            }
            ...
            //播放受击动画和飘字
            GameUtil.CallWithDelay(display.behitDelay, ExecuteBeHit, Source);   // 충격 지연
            ...
            await UniTask.Delay(TimeSpan.FromSeconds(display.duration));    // 애니메이션 시간
        }
