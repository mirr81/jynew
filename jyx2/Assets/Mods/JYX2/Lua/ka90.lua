Talk(0, "이들이 양정천 부부？ 여기 서찰이 있는데 뭐라 쓰여있는지 읽어 보자。", "talkname0", 1);
Talk(107, "신공을 사 단계까지 연마했으나 성곤의 일을 알아 주화입마되었도다。 공력이 고갈된 것도 하늘의 뜻이니 따를 수밖에。 명교를 빛내지 못하고 한 발 먼저 떠나니， 실로 중죄를 지었구나！ 이 유서를 법왕들에게 알려， 금모사왕 사손을 교주로 추대할 것을 전하 노라。", "talkname107", 0);
Talk(0, "양 교주는 무공 연마 중에 성곤의 일을 알아 주화입마 된 것이었군。 교주님 부인은… 여기 비수가 있군。 죄책감에 자결하신거야。 양피에 적힌 글귀를 보니 아마 생전 양교주가 연마하던 신공인 것 같구나。", "talkname0", 1);
AddItem(92, 1);
