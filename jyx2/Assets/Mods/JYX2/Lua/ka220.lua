...
Talk(20, "화산파 제자였군！ 악장문도 무공으로 결정하길 원하시오？", "talkname20", 0);
...
Talk(20, "화산파가 찬성할 줄이야！ 나 천문이 화산파의 절기를 시험해 보마！", "talkname20", 0);
Talk(22, "막형， 안심하시오。 오파가 합병하면 우린 사형제가 되지 않소？ 죽은 자 때문에 산 사람의 의를 해칠 순 없지 않겠소？ 형님？", "talkname22", 0);
Talk(20, "제가 나가겠습니다！", "talkname20", 0);
...
Talk(22, "충아， 수고했다。 우리도 어서 화산으로 돌아가자。 산아가 기다린다。", "talkname22", 0);
Talk(19, "그것도 좋은 생각이오！ 다만 승패가 나면 칼을 거두는 걸로 합시다。", "talkname19", 0);
Talk(23, "어느 문파와 상의했단 말이오？ 난 금시초문이요。", "talkname23", 0);
Talk(35, "사부님！ 언제든지 제자를 불러주세요。", "talkname35", 1);
if TryBattle(34) == true then goto label0 end;
    Dead();
    do return end;
::label0::
    LightScence();
    Talk(35, "양보했습니다。 천문 도장。", "talkname35", 1);
...
::label1::
        LightScence();
        Talk(35, "양보 했습니다， 사태。 자， 다음은 누굽니까？", "talkname35", 1);
        Talk(20, "두 번이나 싸웠으니 운기조식하거라。", "talkname20", 0);
        Talk(35, "아직 멀쩡합니다。 막장문， 출수하시죠！", "talkname35", 1);
...
::label3::
                LightScence();
                Talk(35, "모두 이겨냈어， 힘들어 죽겠군。 좌냉선， 당신의 계략은 실패한 것 같군！", "talkname35", 1);
                ...
                Talk(19, "헛소리！ 내 잔재주로 어찌 숭양수를 죽일 수 있겠소？", "talkname19", 0);
                Talk(35, "흥！", "talkname35", 1);
                DarkScence();
